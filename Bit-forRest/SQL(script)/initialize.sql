...
-- 테이블 데이터 forrest.imgs:~84 rows (대략적) 내보내기
DELETE FROM `imgs`;
...
-- 테이블 데이터 forrest.owncoupon:~9 rows (대략적) 내보내기
...
-- 테이블 데이터 forrest.product:~8 rows (대략적) 내보내기
DELETE FROM `product`;
...
INSERT INTO `product` (`prodNo`, `width`, `length`, `height`, `userId`, `prodCondition`, `prodName`, `prodQuantity`, `prodDetail`, `isRental`, `rentalCounting`, `rentalPrice`, `account`, `category`, `divyAddress`, `prodImg`, `recentImg`, `regDate`) VALUES
	('15b74776-2033-4c01-9685-ed46aa6b937a', 10, 10, 2, 'tkdals4534@naver.com', '물품보관승인신청중', '도플갱어 타프 헥사', 1, '[해외]도플갱어 타프 헥사 all in one UV TT5-631 3색 입니다\r\n', 1, 0, 10000, '우리/1235325325', '기타용품', '16873/경기 용인시 수지구 대지로 18/201-1023/ (죽전동)', '31fb43d1-793d-4629-9c6e-05cbbdb73590.webp', NULL, '2022-06-24 15:01:06'),
	('22367a5f-9b0a-4ecc-9464-7f7eed170e07', 10, 10, 2, 'sanstory12rt@naver.com', '물품보관승인신청중', '브래마 3 400 카라반 어닝 하우스', 1, '브래마 3 400 카라반 어닝 하우스 에어빔 텐트+ 매트입니다..! 잘 보관해주시고, 대여할 분들은 대여하세요~', 1, 0, 120000, '국민/4321353521523521', '텐트', '13473/경기 성남시 분당구 경부고속도로 409/220-4431/ (삼평동)', '2181ebf6-5ce8-46ad-ac1f-22e1d8b3e4dc.webp', NULL, '2022-06-24 15:51:20'),
	('29cadabb-2982-4ff2-abd3-c621eff8fe4c', 10, 10, 10, 'qwerty5266@naver.com', '물품보관승인신청중', '메이튼 캠핑 랜턴 조명 감성 LED ', 1, 'c타입 충전기를 써서 편리합니다. 저렴하게 가져가세요!', 1, 0, 10000, '우리/1002250485761', '조명', '13485/경기 성남시 분당구 판교로 20/405/ (판교동, 판교원마을3단지아파트)', '5a2ecf73-e626-4345-a29f-dd52e4d806c9.jpg', NULL, '2022-06-24 20:21:59'),
	('3aa1ecde-b497-46a7-b629-b1ad08342da1', 10, 10, 10, 'sanstory12rt@naver.com', '물품보관승인신청중', '감성좋은 행복한 텐트', 1, '행복이 넘치는 감성넘치는 좋은 텐트입니다.', 1, 0, 100, '국민/292-12392193-4578', '텐트', '06035/서울 강남구 가로수길 5/5986호/ (신사동)', '40eff2d4-dce4-4fba-a7cc-68e2c072bf7c.jpg', NULL, '2022-06-24 20:20:01'),
	('48acf057-13d0-411d-81dd-bec5b8e0cbf3', 10, 10, 2, 'kedee2001@naver.com', '물품보관승인신청중', '불멍 캠핑 가정용 에탄올 난로 미니 ', 1, '불멍 캠핑 가정용 에탄올 난로 입니다!\r\n', 1, 0, 2000, '국민/1242151525125', '기타용품', '16872/경기 용인시 수지구 대지로 49/106-4210/ (죽전동, 죽전퍼스트하임)', 'ac89bba4-c826-4401-8e98-7ea2107d7934.webp', NULL, '2022-06-24 20:23:19'),
	('4a0ad7a7-8f0c-4900-8518-69c8c2a9c2aa', 10, 10, 2, 'sanstory12rt@naver.com', '물품보관승인신청중', '리버 프로 + 110W태양광패널', 1, '리버 프로 + 110W태양광패널 + 확장배터리 세트 파워뱅크 720Wh 1800W 220V\r\n\r\n', 1, 0, 50000, '국민/4321353521523521', '기타용품', '13487/경기 성남시 분당구 대왕판교로 579/22-232/ (삼평동)', 'a1bdb845-cea3-4229-b0d3-77eadd70fc24.jpg', NULL, '2022-06-24 15:36:07'),
...
-- 테이블 데이터 forrest.transaction:~8 rows (대략적) 내보내기
...
INSERT INTO `user` (`userId`, `nickname`, `phone`, `password`, `userName`, `userAddr`, `role`, `joinDate`, `joinPath`, `userImg`, `recentDate`, `pushToken`, `leaveApplyDate`, `leaveDate`) VALUES
	...
	('captain9697@naver.com', '구스범수', '010/4114/9697', '$2a$10$jX/xb.arDJYDOqokfAJNkeg3ISGU1vTHG1t7lA2TxR7xbgTYVb6RG', '박범수', '13271/경기 성남시 수정구 산성대로 341/5동 502호/ (신흥동, 한신아파트)', 'user', '2022-06-24 00:00:00', 'own', 'goosebeomImg.jpg', '2022-06-24 20:18:14', NULL, NULL, NULL),
	...
	('sanstory12rt@naver.com', '과자조아', '010/8783/6065', '$2a$10$jX/xb.arDJYDOqokfAJNkeg3ISGU1vTHG1t7lA2TxR7xbgTYVb6RG', '형산', '18112/경기 오산시 세교동 587/303-4201/ (세교동, 오산세교주상1블록)', 'user', '2022-06-24 00:00:00', 'own', 'iu.jpg', '2022-06-24 20:18:08', NULL, NULL, NULL),
	('tkdals4534@naver.com', '이어폰폴펜', '01033294534', '$2a$10$jX/xb.arDJYDOqokfAJNkeg3ISGU1vTHG1t7lA2TxR7xbgTYVb6RG', '이상민', '13121/경기 성남시 수정구 창곡동 501/3603동 1112호/ (창곡동, 성남위례 LH36단지)', 'user', '2022-06-22 09:45:34', 'own', NULL, '2022-06-24 20:19:14', NULL, NULL, NULL),
