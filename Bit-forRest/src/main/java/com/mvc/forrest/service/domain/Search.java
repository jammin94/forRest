...
public class Search {
	...
	public String getSearchProductCondition() {
		return searchProductCondition;
	}

	public void setSearchProductCondition(String searchProductCondition) {
		this.searchProductCondition = searchProductCondition;
	}
