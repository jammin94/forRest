...
public class KakaoLoginService {
	...
	public String getKakaoToken(String authorization_code) throws Exception{
	...
	public String getNaverToken(String code, String state) throws Exception{
		...
		StringBuilder sb = new StringBuilder();
		sb.append("grant_type=authorization_code");
		sb.append("&client_id=RxuYhXapOnqUmHtxXu7S");
		sb.append("&client_secret=XGYQZxDwdG");
		sb.append("&redirect_uri=http://localhost:8080/snsLogin/naverLogin");
		sb.append("&code=" + code);
	...
	public Map<String, Object> getNaverInfo(String access_Token) throws Exception{
		System.out.println("### getUserInfo Start ###");
